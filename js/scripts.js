...
// this script adapted from https://www.w3schools.com/howto/tryit.asp?filename=tryhow_js_typewriter
var i = 0;
strings = ["TENT POLES", "HARNESS", "SUNSCREEN", "ICE AXE", "SWIM SUIT", "SKI BOOTS", "FIRST AID KIT", "PASSPORT", "BUG SPRAY", "GLOVES", "HELMET", "BATTERIES"];
var l = strings.length
var txt = string[0]; /* The text - element will by from 0 to (l-1) */
